    ...
    <div className="details-content">
      <div className="details-filters">
        <div className="details-filter">
          <Image src="/images/icons/locIcon.png" alt="Localização" width={24} height={24} />
          <span>{hotel.address.length > 0 ? hotel.location : 'Endereço não informado'}</span>
        </div>

        <div className="details-filter">
          <Image src="/images/icons/calendarIcon.png" alt="Datas" width={24} height={24} />
        ...
        <div className="details-filter">
          <Image src="/images/icons/userIcon.png" alt="Hóspedes" width={24} height={24} />
          <span className="details-filter-span">
